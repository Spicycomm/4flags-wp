=== Portfolio Gallery - Responsive Galleries, Image, Photo, Album, Slider, Animation Menu, Lightbox ===
Contributors: totalsoft
Donate link: http://total-soft.pe.hu/gallery-portfolio
Tags: portfolio, gallery, wordpress gallery, images portfolio, portfolio gallery, portfolio plugin, images gallery, responsive portfolio, wordpress portfolio, wp portfolio, sortable portfolio, photo portfolio, gallery lightbox,
...
Gallery plugin created for persons who like to show their photos in high quality with the best gallery design. Portfolio plugin will help you more easily create image gallery, photo album, portfolio, grid image and slider portfolio.

== Description ==

= Gallery - Total-Soft Portfolio Gallery =
...
>
>[Portfolio Galeery / Hover Effects - Demo Version](http://total-soft.pe.hu/wordpress-portfolio-gallery-hover-effects-one) | [[Portfolio Galeery / Hover Effects - Demo Version](http://total-soft.pe.hu/wordpress-portfolio-gallery-hover-effects-two) | [Portfolio Galeery / Hover Effects - Demo Version](http://total-soft.pe.hu/wordpress-portfolio-gallery-hover-effects-three)
...
= Pay for the Pro version and until now have not received the link or file updating. Please help. What to do? =

* If you make a purchase and haven't received **Gallery-Portfolio.zip** file or you just got and it have some problem, contact us on our Email address totalsoft.team@gmail.com. Please send us the order number which you received after purchasing the Portfolio Gallery. We will check it and send you directly.
...
= My images are stretching and showing no standard. How can I mend it? =
...
* Filterable Grid : Fixed error with Popup Arrows. Changed navigation style and popup style.
* Portfolio / Hover Effects : Fixed problem with editing the images.
* Slider Portfolio : Changed background color to transparent.
* Lightbox Gallery : Fixed CSS style issue with navigation effects.
* Added Possibility to make a duplicate images in admin menu.

= Version 1.2.0 =

* Add New Type "Lightbox Gallery"
* Fixed CSS with full popup in elastic grid.

= Version 1.1.8 =

* Changed CSS style for Total Soft Portfolio type.
* Fixed error in basic function with Elastic Grid type.
* Added possibility to multiple shortcodes on one page.

= Version 1.1.7 =

* Changed database functions and tables.

= Version 1.1.6 =

* Multiple galleries can be added on the same page.
* In the type "Album Animation" fixed an error with the title.
* In the type "Elastic Grid" fixed bug about working on mobile.
* In the type "Filterable Grid" for the safari runs a hover effects.
* In the type "Filterable Grid" fixed responsiveness on mobile.

= Version 1.1.5 =

* Add New Type "Gallery Portfolio / Hover Effects"
...
* Lightbox Font Size - This function is for the popup window. You can select font size for title. For each screen or mobile version will be its size for responsiveness.
* Lightbox Font Family - Specify the font family for the title, used with image in a popup window.
* Lightbox Color - In gallery it is necessary to choose the color for image titles which is in the popup window.
* Lightbox Background Color - Determine the background color which is designed for lightbox title.
...
* Lightbox Background Color - Open the gallery edit and choose your preferable background color for popup.
* Lightbox Border Width - Determine the width of the border for the container in a popup window.
* Lightbox Border Style - Select the style for the border of the popup.
* Lightbox Border Color - Determine border color which is in the popup.
* Lightbox Border Radius - In the popup window it is possible to give a border radius. You can specify the radius of the pixels. In gallery it is all responsive.
...
* Album Color - Choose your preferable color for select menu.
* Album Background Color - Choose your preferable background color for select menu.
* Album Hover Color - Select the menu font color when the portfolio is separated by categories.
* Album Hover Background Color - Select the menu background color when the portfolio is separated by categories.
...
* Thumbnails Width in Full Screen - Select the width of the full screen view in lightbox.
* Thumbnails Height in Full Screen - Select the height of the full screen view in lightbox.
* Thumbnails Position - Choose position for the thumbnail.
* Thumbnails Portfolio Thumbnail Type - Select one of this three options for thumbnails view.
