		...
		function __construct()
 		...
 		function widget($args,$instance)
 		{
			...
			if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Filterable Grid')
			{
				...
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-angle-double-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-angle-double-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '2')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-angle-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-angle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '3')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-arrow-circle-left'; $TotalSoft_FG_Slider_Icon_Right ='totalsoft totalsoft-arrow-circle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '4')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-arrow-circle-o-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-arrow-circle-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '5')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-arrow-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-arrow-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '6')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-caret-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-caret-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '7')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-caret-square-o-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-caret-square-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '8')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-chevron-circle-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-chevron-circle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '9')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-chevron-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-chevron-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '10')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-hand-o-left'; $TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-hand-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_24 == '11')
				{
					$TotalSoft_FG_Slider_Icon_Left = 'totalsoft totalsoft-long-arrow-left';	$TotalSoft_FG_Slider_Icon_Right = 'totalsoft totalsoft-long-arrow-right';
				}
				if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27=='1') { $TotalSoft_FG_Slider_Del_Icon_Type='totalsoft totalsoft-times'; }
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27=='2') { $TotalSoft_FG_Slider_Del_Icon_Type='totalsoft totalsoft-times-circle-o'; }
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27=='3')	{ $TotalSoft_FG_Slider_Del_Icon_Type='totalsoft totalsoft-times-circle'; }
				if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='1') { $Pop_Ic_Type='totalsoft totalsoft-file-image-o'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='2') { $Pop_Ic_Type='totalsoft totalsoft-eye'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='3') { $Pop_Ic_Type='totalsoft totalsoft-camera-retro'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='4') { $Pop_Ic_Type='totalsoft totalsoft-picture-o'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='5') { $Pop_Ic_Type='totalsoft totalsoft-search-plus'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='6')	{ $Pop_Ic_Type='totalsoft totalsoft-expand'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='7') { $Pop_Ic_Type='totalsoft totalsoft-gratipay'; }
				else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_34=='8')	{ $Pop_Ic_Type='totalsoft totalsoft-search'; }
				if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='1')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-angle-double-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-angle-double-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='2')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-angle-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-angle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='3')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-arrow-circle-left';	$TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-arrow-circle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='4')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-arrow-circle-o-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-arrow-circle-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='5')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-arrow-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-arrow-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='6')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-caret-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-caret-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='7')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-caret-square-o-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-caret-square-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='8')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-chevron-circle-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-chevron-circle-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='9')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-chevron-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-chevron-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='10')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-hand-o-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-hand-o-right';
				}
				else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_31=='11')
				{
					$TotalSoft_FG_Car_Slider_Icon_Left='totalsoft totalsoft-long-arrow-left'; $TotalSoft_FG_Car_Slider_Icon_Right='totalsoft totalsoft-long-arrow-right';
				}
			}
 		 	echo $before_widget;
 		 	?>
 		 	...
 		 	<?php if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Total Soft Portfolio'){ ?>
 		 		<style type="text/css">
 		 			.portfolio_<?php echo $Total_Soft_Portfolio;?> { height:0px; }
					...
					.Total_Soft_Portfolio_Icon_<?php echo $Total_Soft_Portfolio;?>:hover { opacity:0.8; }
					.gallery<?php echo $Total_Soft_Portfolio;?> { margin-left:0px !important; margin-right:0px !important; }						
 		 		</style>
				<div class="portfolio portfolio<?php echo $Total_Soft_Portfolio;?> portfolio_<?php echo $Total_Soft_Portfolio;?>">
					<input type="text" style="display:none;" class="TotalSoftPortfolio_IW<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_03;?>">
					<input type="text" style="display:none;" class="TotalSoftPortfolio_IH<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_04;?>">
					<input type="text" style="display:none;" class="TotalSoftPortfolio_NavS<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_09;?>">
					<input type="text" style="display:none;" class="portDivHeigt<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_01;?>">
					<input type="text" style="display:none;" class="portItemHeigt<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_04+100;?>">
					<input type="text" style="display:none;" class="portImHeigt<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_04;?>">
					<input type="text" style="display:none;" class="portImWidth<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_03;?>">
					<input type="text" style="display:none;" class="TSICWidth<?php echo $Total_Soft_Portfolio;?>" value="<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_16;?>">
					<div class="background background_<?php echo $Total_Soft_Portfolio;?>"></div>		
					<div class="arrows">
						<span class="up up<?php echo $Total_Soft_Portfolio;?>" style='text-align:center;'><i class="TSIC Total_Soft_Portfolio_Icon_<?php echo $Total_Soft_Portfolio;?> <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_17;?>"></i></span>
						<span class="down down<?php echo $Total_Soft_Portfolio;?>" style='text-align:center;'><i class="TSIC Total_Soft_Portfolio_Icon_<?php echo $Total_Soft_Portfolio;?> <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19;?>"></i></span>
						<span class="prev prev<?php echo $Total_Soft_Portfolio;?> portIcLeft"><i class="TSIC Total_Soft_Portfolio_Icon_<?php echo $Total_Soft_Portfolio;?> <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_18;?>"></i></span>
						<span class="next next<?php echo $Total_Soft_Portfolio;?> portIcRight" style='text-align:right;'><i class="TSIC Total_Soft_Portfolio_Icon_<?php echo $Total_Soft_Portfolio;?> <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_20;?>"></i></spana>
					</div>
				...
				<script type="text/javascript">
					(function($){
						jQuery(document).ready(function(){
							...
							if(!portfolioparentwidth<?php echo $Total_Soft_Portfolio;?>) { setTimeout(function(){ resp<?php echo $Total_Soft_Portfolio;?>(); },500)	}
					    ...
					    $.fn.portfolio<?php echo $Total_Soft_Portfolio;?> = function(options) {
							...
							var portfolioparentwidth<?php echo $Total_Soft_Portfolio;?> = jQuery('.portfolio_<?php echo $Total_Soft_Portfolio;?>').parent().width();
							if(!portfolioparentwidth<?php echo $Total_Soft_Portfolio;?>) { portfolioparentwidth<?php echo $Total_Soft_Portfolio;?> = 800; }
							var d = {
								image: {
										...
										animate: {
											item: function(){
												var down<?php echo $Total_Soft_Portfolio;?> = { top: '-='+(s.image.height+s.image.margin)+'px' },
													...
													next<?php echo $Total_Soft_Portfolio;?> = { top: 0, left: '-='+(s.image.width+s.image.margin)+'px' },
													prev<?php echo $Total_Soft_Portfolio;?> = { top: 0, left: '+='+(s.image.width+s.image.margin)+'px' }
										...
										position: {
											...
											check: function(top, left){
												...
												var items = $t.find('.item'),
													...
													up<?php echo $Total_Soft_Portfolio;?> = arrows.find('.up<?php echo $Total_Soft_Portfolio;?>'), down<?php echo $Total_Soft_Portfolio;?> = arrows.find('.down<?php echo $Total_Soft_Portfolio;?>'),
													next<?php echo $Total_Soft_Portfolio;?> = arrows.find('.next<?php echo $Total_Soft_Portfolio;?>'), prev<?php echo $Total_Soft_Portfolio;?> = arrows.find('.prev<?php echo $Total_Soft_Portfolio;?>');
												if (left==max_left){ next<?php echo $Total_Soft_Portfolio;?>.hide(); } else { next<?php echo $Total_Soft_Portfolio;?>.show(); }
												if (left<0) { prev<?php echo $Total_Soft_Portfolio;?>.show(); } else { prev<?php echo $Total_Soft_Portfolio;?>.hide(); }
												if (top==max_top){ down<?php echo $Total_Soft_Portfolio;?>.hide(); } else { down<?php echo $Total_Soft_Portfolio;?>.show(); }
												if (top<0) { up<?php echo $Total_Soft_Portfolio;?>.show(); } else { up<?php echo $Total_Soft_Portfolio;?>.hide(); }
				...
				<script type="text/javascript">
					...
					jQuery(function(){ o<?php echo $Total_Soft_Portfolio;?>.init(); });
				</script>
	 		<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Elastic Grid'){	?>
 				<style type="text/css">
					...
					{
						display: <?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02=='false'){echo 'none';}?>
					}
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?> { list-style: none; padding: 20px 0 !important; margin: 0 auto !important; text-align: center; width: 100%; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li { display: inline-block; margin: 10px 5px 0 5px !important;	vertical-align: top; padding: 0 !important; position: static !important; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li.hidden { display: none;	}
					.og-grid<?php echo $Total_Soft_Portfolio;?> li > a, .og-grid<?php echo $Total_Soft_Portfolio;?> li > a img { border: none; outline: none; display: block; position: relative; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a:hover, .og-grid<?php echo $Total_Soft_Portfolio; ?> li a:focus { border-bottom: none !important; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a { overflow: hidden; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a.unhoverdir { overflow: visible; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a figure { position: absolute; width: 100%; height: 100%; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a figure span {	display: block;	padding: 10px 0; margin: 40px 20px 20px 20px; font-weight: normal; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-opacity li.animate 
					{
						-webkit-animation: fadeIn 0.65s ease forwards;
						-moz-animation: fadeIn 0.65s ease forwards;
						animation: fadeIn 0.65s ease forwards;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-moveup li.animate 
					{
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-scaleup li.animate 
					{
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-fallperspective 
					{
						-webkit-perspective: 1300px;
						-moz-perspective: 1300px;
						perspective: 1300px;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-fallperspective li.animate 
					{
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-fly 
					{
						-webkit-perspective: 1300px;
						-moz-perspective: 1300px;
						perspective: 1300px;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-fly li.animate 
					{
						-webkit-transform-style: preserve-3d;
						-moz-transform-style: preserve-3d;
						transform-style: preserve-3d;
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-flip 
					{
						-webkit-perspective: 1300px;
						-moz-perspective: 1300px;
						perspective: 1300px;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-flip li.animate 
					{
						-webkit-transform-style: preserve-3d;
						-moz-transform-style: preserve-3d;
						transform-style: preserve-3d;
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-helix 
					{
						-webkit-perspective: 1300px;
						-moz-perspective: 1300px;
						perspective: 1300px;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-helix li.animate 
					{
						-webkit-transform-style: preserve-3d;
						-moz-transform-style: preserve-3d;
						transform-style: preserve-3d;
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-popup 
					{
						-webkit-perspective: 1300px;
						-moz-perspective: 1300px;
						perspective: 1300px;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?>.effect-popup li.animate 
					{
						-webkit-transform-style: preserve-3d;
						-moz-transform-style: preserve-3d;
						transform-style: preserve-3d;
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?> .sep { display: none;}
					.og-grid<?php echo $Total_Soft_Portfolio; ?> .sep { margin: 20px 10px; height: 80%}
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li { height:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_22;?>px; }
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li > a,.og-grid<?php echo $Total_Soft_Portfolio; ?> li > a img 
					{
					...
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a:hover, .og-grid<?php echo $Total_Soft_Portfolio; ?> li a:focus
					{
						-webkit-box-shadow:0px 0px 20px <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_24;?>; 
						-moz-box-shadow:0px 0px 20px <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_24;?>; 
						box-shadow:0px 0px 20px <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_24;?>; 
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a figure 
					{
						background-color:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_25;?>;
						margin: 0;
					}
					.og-grid<?php echo $Total_Soft_Portfolio; ?> li a figure span 
					{
					...
					.og-expander<?php echo $Total_Soft_Portfolio; ?> 
					{
						background-color:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_32;?>;
						overflow: auto;
						padding-bottom: 5px;
						max-height: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08;?>px;
					}
					/* Events List custom webkit scrollbar */
					.og-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar {width: 9px;}
					/* Track */
					.og-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar-track {background: none;}
					/* Handle */
					.og-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar-thumb 
					{
						background:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_33;?>;
						border:1px solid #E9EBEC;
						border-radius: 10px;
					}
					.og-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar-thumb:hover {background:#cecece;}
					.og-pointer<?php echo $Total_Soft_Portfolio; ?>
					{
						border-bottom-color:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_32;?> !important;
					}
					.og-details<?php echo $Total_Soft_Portfolio; ?> h3
					{
					...
					.og-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2) { max-height:200px !important; overflow-x:hidden; }
					.og-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2)::-webkit-scrollbar {	width: 0.5em; }
					.og-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2)::-webkit-scrollbar-track
					{
						-webkit-box-shadow: inset 0 0 6px <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_32; ?>;
					}
					.og-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2)::-webkit-scrollbar-thumb 
					{
					...
					.og-details<?php echo $Total_Soft_Portfolio; ?> a.link-button 
					{
					...
					.og-details<?php echo $Total_Soft_Portfolio; ?> a:hover 
					{
					...
					.og-details<?php echo $Total_Soft_Portfolio; ?> .infosep 
					{
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li { min-width: 20px; margin: 0 5px !important; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper { position: relative; margin: 0 auto; min-height: 60px; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper.elastislide<?php echo $Total_Soft_Portfolio; ?>-loading 
					{
						background-image: url(../Images/loading.gif);
						background-repeat: no-repeat;
						background-position: center center;
					}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav	{ padding: 0 !important; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal { padding: 10px 40px; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-vertical {	padding: 40px 10px;	}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel {	overflow: hidden; position: relative; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul 
					{
						position: relative;
						display: block;
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal ul { white-space: nowrap; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li 
					{
						margin: 0;
						-webkit-backface-visibility: hidden;
						-moz-backface-visibility: hidden;
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal ul li { height: 100%; display: inline-block; width:100px !important; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-vertical ul li { display: block; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a {	display: inline-block; width: 100%;	padding: 0px; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a img { display: block; max-width: 100%; }
					/* Navigation Arrows */
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper nav span {	position: absolute;	border-radius: 50%;	cursor: pointer; opacity: 0.8; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper nav span:hover { opacity: 1.0 }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span { top: 50%; left: 10px; margin-top: -11px;	}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span.elastislide<?php echo $Total_Soft_Portfolio; ?>-next { right: 10px; left: auto; }
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-list li a:hover, .elastislide<?php echo $Total_Soft_Portfolio; ?>-list li a:focus
					{
						box-shadow: none !important;
						-moz-box-shadow: none !important;
						-webkit-box-shadow: none !important;
					}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-TS_Portfolio_GAA_
					{
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-list li a img, .elastislide<?php echo $Total_Soft_Portfolio; ?>-list li a, .elastislide<?php echo $Total_Soft_Portfolio; ?>-list li, .elastislide<?php echo $Total_Soft_Portfolio; ?>-list
					{
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a img 
					{
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a img.selected 
					{
						border-color: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_17;?>;
					}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span.totalsoft
					{
					...
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span.totalsoft.elastislide<?php echo $Total_Soft_Portfolio; ?>-next:before
					{
						<?php if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '1'){ ?>
							content: '\f101';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '2'){ ?>
							content: '\f105';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '3'){ ?>
							content: '\f0a9';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '4'){ ?>
							content: '\f18e';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '5'){ ?>
							content: '\f061';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '6'){ ?>
							content: '\f0da';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '7'){ ?>
							content: '\f152';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '8'){ ?>
							content: '\f054';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '9'){ ?>
							content: '\f138';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '10'){ ?>
							content: '\f0a4';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '11'){ ?>
							content: '\f178';
						<?php }?>									
					}
					.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span.totalsoft.elastislide<?php echo $Total_Soft_Portfolio; ?>-prev:before
					{
						<?php if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '1'){ ?>
							content: '\f100';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18 == '2'){ ?>
					...
					.og-close<?php echo $Total_Soft_Portfolio; ?>.totalsoft
					{
					...
					.og-close<?php echo $Total_Soft_Portfolio; ?>.totalsoft:before
					{
						<?php if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_23 == '1'){ ?>
							content: '\f057';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_23 == '2'){ ?>
							content: '\f05c';
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_23 == '3'){ ?>
							content: '\f00d';
						<?php }?>	
					}
					@media only screen and (max-width : 480px) { .elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper { max-width: 300px; } }
					@media (max-width: 767px) 
					{							
						.elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal ul li { width:100px !important;	}						
						.elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper { max-width: 300px; padding-bottom: 5px; }
					}
 				</style>
				<div id="elastic_grid_demo<?php echo $Total_Soft_Portfolio; ?>"></div>
				...
				<script type="text/javascript">
					(function(g,h,e){var a=g.event,b,j;b=a.special.debouncedresize={setup:function(){g(this).on("resize",b.handler)},teardown:function(){g(this).off("resize",b.handler)},handler:function(o,k){var n=this,m=arguments,l=function(){o.type="debouncedresize";a.dispatch.apply(n,m)};if(j){clearTimeout(j)}k?l():j=setTimeout(l,b.threshold)},threshold:150};var c="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";g.fn.imagesLoaded=function(r){var o=this,t=g.isFunction(g.Deferred)?g.Deferred():0,s=g.isFunction(t.notify),l=o.find("img").add(o.filter("img")),m=[],q=[],n=[];if(g.isPlainObject(r)){g.each(r,function(u,v){if(u==="callback"){r=v}else{if(t){t[u](v)}}})}function p(){var u=g(q),v=g(n);if(t){if(n.length){t.reject(l,u,v)}else{t.resolve(l)}}if(g.isFunction(r)){r.call(o,l,u,v)}}function k(u,v){if(u.src===c||g.inArray(u,m)!==-1){return}m.push(u);if(v){n.push(u)}else{q.push(u)}g.data(u,"imagesLoaded",{isBroken:v,src:u.src});if(s){t.notifyWith(g(u),[v,l,g(q),g(n)])}if(l.length===m.length){setTimeout(p);l.unbind(".imagesLoaded")}}if(!l.length){p()}else{l.bind("load.imagesLoaded error.imagesLoaded",function(u){k(u.target,u.type==="error")}).each(function(u,w){var x=w.src;var v=g.data(w,"imagesLoaded");if(v&&v.src===x){k(w,v.isBroken);return}if(w.complete&&w.naturalWidth!==e){k(w,w.naturalWidth===0||w.naturalHeight===0);return}if(w.readyState||w.complete){w.src=c;w.src=x}})}return t?t.promise(o):o};var d=g(h),f=h.Modernizr;g.Elastislide<?php echo $Total_Soft_Portfolio; ?>=function(k,l){this.$el=g(l); this._init(k)};g.Elastislide<?php echo $Total_Soft_Portfolio; ?>.defaults={orientation:"horizontal",speed:500,easing:"ease-in-out",minItems:3,start:0,onClick:function(m,k,l){return false},onReady:function(){return false},onBeforeSlide:function(){return false},onAfterSlide:function(){return false}};g.Elastislide<?php echo $Total_Soft_Portfolio; ?>.prototype={_init:function(l){this.options=g.extend(true,{},g.Elastislide<?php echo $Total_Soft_Portfolio; ?>.defaults,l);var k=this,m={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"};this.transEndEventName=m[f.prefixed("transition")];this.support=f.csstransitions&&f.csstransforms;this.current=this.options.start;this.isSliding=false;this.$items=this.$el.children("li");this.itemsCount=this.$items.length;if(this.itemsCount===0){return false}this._validate();this.$items.detach();this.$el.empty();this.$el.append(this.$items);this.$el.wrap('<div class="elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper elastislide<?php echo $Total_Soft_Portfolio; ?>-loading elastislide<?php echo $Total_Soft_Portfolio; ?>-'+this.options.orientation+'"></div>');this.hasTransition=false;this.hasTransitionTimeout=setTimeout(function(){k._addTransition()},100);this.$el.imagesLoaded(function(){k.$el.show();k._layout();k._configure();if(k.hasTransition){k._removeTransition();k._slideToItem(k.current);k.$el.on(k.transEndEventName,function(){k.$el.off(k.transEndEventName);k._setWrapperSize();k._addTransition();k._initEvents()})}else{clearTimeout(k.hasTransitionTimeout);k._setWrapperSize();k._initEvents();k._slideToItem(k.current);setTimeout(function(){k._addTransition()},25)}k.options.onReady()})},_validate:function(){if(this.options.speed<0){this.options.speed=500}if(this.options.minItems<1||this.options.minItems>this.itemsCount){this.options.minItems=1}if(this.options.start<0||this.options.start>this.itemsCount-1){this.options.start=0}if(this.options.orientation!="horizontal"&&this.options.orientation!="vertical"){this.options.orientation="horizontal"}},_layout:function(){this.$el.wrap('<div class="elastislide<?php echo $Total_Soft_Portfolio; ?>-carousel"></div>');this.$carousel=this.$el.parent();this.$wrapper=this.$carousel.parent().removeClass("elastislide<?php echo $Total_Soft_Portfolio; ?>-loading");var k=this.$items.find("img:first");this.imgSize={width:k.outerWidth(true),height:k.outerHeight(true)};this._setItemsSize(); this.options.orientation==="horizontal"?this.$el.css("max-height",this.imgSize.height):this.$el.css("height",this.options.minItems*this.imgSize.height); this._addControls()},_addTransition:function(){if(this.support){this.$el.css("transition","all "+this.options.speed+"ms "+this.options.easing)}this.hasTransition=true},_removeTransition:function(){if(this.support){this.$el.css("transition","all 0s")}this.hasTransition=false},_addControls:function(){var k=this;this.$navigation=g('<nav><span class="elastislide<?php echo $Total_Soft_Portfolio; ?>-prev totalsoft"></span><span class="elastislide<?php echo $Total_Soft_Portfolio; ?>-next totalsoft"></span></nav>').appendTo(this.$wrapper); this.$navPrev=this.$navigation.find("span.elastislide<?php echo $Total_Soft_Portfolio; ?>-prev").on("mousedown.elastislide<?php echo $Total_Soft_Portfolio; ?>",function(l){k._slide("prev");return false});this.$navNext=this.$navigation.find("span.elastislide<?php echo $Total_Soft_Portfolio; ?>-next").on("mousedown.elastislide<?php echo $Total_Soft_Portfolio; ?>",function(l){k._slide("next");return false})},_setItemsSize:function(){var k=this.options.orientation==="horizontal"?(Math.floor(this.$carousel.width()/this.options.minItems)*100)/this.$carousel.width():100;this.$items.css({width:k+"%","max-width":this.imgSize.width,"max-height":this.imgSize.height}); if(this.options.orientation==="vertical"){this.$wrapper.css("max-width",this.imgSize.width+parseInt(this.$wrapper.css("padding-left"))+parseInt(this.$wrapper.css("padding-right")))}},_setWrapperSize:function(){if(this.options.orientation==="vertical"){this.$wrapper.css({height:this.options.minItems*this.imgSize.height+parseInt(this.$wrapper.css("padding-top"))+parseInt(this.$wrapper.css("padding-bottom"))})}},_configure:function(){this.fitCount=this.options.orientation==="horizontal"?this.$carousel.width()<this.options.minItems*this.imgSize.width?this.options.minItems:Math.floor(this.$carousel.width()/this.imgSize.width):this.$carousel.height()<this.options.minItems*this.imgSize.height?this.options.minItems:Math.floor(this.$carousel.height()/this.imgSize.height)},_initEvents:function(){var k=this;d.on("debouncedresize.elastislide<?php echo $Total_Soft_Portfolio; ?>",function(){k._setItemsSize();k._configure();k._slideToItem(k.current)});this.$el.on(this.transEndEventName,function(){k._onEndTransition()});if(this.options.orientation==="horizontal"){this.$el.on({swipeleft:function(){k._slide("next")},swiperight:function(){k._slide("prev")}})}else{this.$el.on({swipeup:function(){k._slide("next")},swipedown:function(){k._slide("prev")}})}this.$el.on("click.elastislide<?php echo $Total_Soft_Portfolio; ?>","li",function(m){var l=g(this);k.options.onClick(l,l.index(),m)})},_destroy:function(k){this.$el.off(this.transEndEventName).off("swipeleft swiperight swipeup swipedown .elastislide<?php echo $Total_Soft_Portfolio; ?>");d.off(".elastislide<?php echo $Total_Soft_Portfolio; ?>");this.$el.css({"max-height":"none",transition:"none"}).unwrap(this.$carousel).unwrap(this.$wrapper);this.$items.css({width:"auto","max-width":"none","max-height":"none"});this.$navigation.remove();this.$wrapper.remove();if(k){k.call()}},_toggleControls:function(k,l){if(l){(k==="next")?this.$navNext.show():this.$navPrev.show()}else{(k==="next")?this.$navNext.hide():this.$navPrev.hide()}},_slide:function(l,n){if(this.isSliding){return false}this.options.onBeforeSlide();this.isSliding=true;var t=this,k=this.translation||0,q=this.options.orientation==="horizontal"?this.$items.outerWidth(true):this.$items.outerHeight(true),o=this.itemsCount*q,m=this.options.orientation==="horizontal"?this.$carousel.width():this.$carousel.height();if(n===e){var p=this.fitCount*q;if(p<0){return false}if(l==="next"&&o-(Math.abs(k)+p)<m){p=o-(Math.abs(k)+m);this._toggleControls("next",false);this._toggleControls("prev",true)}else{if(l==="prev"&&Math.abs(k)-p<0){p=Math.abs(k);this._toggleControls("next",true);this._toggleControls("prev",false)}else{var s=l==="next"?Math.abs(k)+Math.abs(p):Math.abs(k)-Math.abs(p);s>0?this._toggleControls("prev",true):this._toggleControls("prev",false);s<o-m?this._toggleControls("next",true):this._toggleControls("next",false)}}n=l==="next"?k-p:k+p}else{var p=Math.abs(n);if(Math.max(o,m)-p<m){n=-(Math.max(o,m)-m)}p>0?this._toggleControls("prev",true):this._toggleControls("prev",false);Math.max(o,m)-m>p?this._toggleControls("next",true):this._toggleControls("next",false)}this.translation=n;if(k===n){this._onEndTransition();return false}if(this.support){this.options.orientation==="horizontal"?this.$el.css("transform","translateX("+n+"px)"):this.$el.css("transform","translateY("+n+"px)")}else{g.fn.applyStyle=this.hasTransition?g.fn.animate:g.fn.css;var r=this.options.orientation==="horizontal"?{left:n}:{top:n};this.$el.stop().applyStyle(r,g.extend(true,[],{duration:this.options.speed,complete:function(){t._onEndTransition()}}))}if(!this.hasTransition){this._onEndTransition()}},_onEndTransition:function(){this.isSliding=false;this.options.onAfterSlide()},_slideTo:function(o){var o=o||this.current,n=Math.abs(this.translation)||0,m=this.options.orientation==="horizontal"?this.$items.outerWidth(true):this.$items.outerHeight(true),l=n+this.$carousel.width(),k=Math.abs(o*m);if(k+m>l||k<n){this._slideToItem(o)}},_slideToItem:function(l){var k=this.options.orientation==="horizontal"?l*this.$items.outerWidth(true):l*this.$items.outerHeight(true); this._slide("",-k)},add:function(n){var k=this,m=this.current,l=this.$items.eq(this.current);this.$items=this.$el.children("li");this.itemsCount=this.$items.length;this.current=l.index();this._setItemsSize();this._configure();this._removeTransition();m<this.current?this._slideToItem(this.current):this._slide("next",this.translation);setTimeout(function(){k._addTransition()},25);if(n){n.call()}},setCurrent:function(k,l){this.current=k;this._slideTo();if(l){l.call()}},next:function(){self._slide("next")},previous:function(){self._slide("prev")},slideStart:function(){this._slideTo(0)},slideEnd:function(){this._slideTo(this.itemsCount-1)},destroy:function(k){this._destroy(k)}};var i=function(k){if(h.console){h.console.error(k)}};g.fn.elastislide<?php echo $Total_Soft_Portfolio; ?>=function(m){var k=g.data(this,"elastislide<?php echo $Total_Soft_Portfolio; ?>");if(typeof m==="string"){var l=Array.prototype.slice.call(arguments,1);this.each(function(){if(!k){i("cannot call methods on elastislide<?php echo $Total_Soft_Portfolio; ?> prior to initialization; attempted to call method '"+m+"'");return}if(!g.isFunction(k[m])||m.charAt(0)==="_"){i("no such method '"+m+"' for elastislide<?php echo $Total_Soft_Portfolio; ?> self");return}k[m].apply(k,l)})}else{this.each(function(){if(k){k._init()}else{k=g.data(this,"elastislide<?php echo $Total_Soft_Portfolio; ?>",new g.Elastislide<?php echo $Total_Soft_Portfolio; ?>(m,this))}})}return k}})(jQuery,window);(function(c,b,d){c.HoverDir=function(e,f){this.$el=c(f);this._init(e)};c.HoverDir.defaults={speed:300,easing:"ease",hoverDelay<?php echo $Total_Soft_Portfolio; ?>:0,inverse:false};c.HoverDir.prototype={_init:function(e){this.options=c.extend(true,{},c.HoverDir.defaults,e);this.transitionProp="all "+this.options.speed+"ms "+this.options.easing;this.support=Modernizr.csstransitions;this._loadEvents()},_loadEvents:function(){var e=this;this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir",function(i){var g=c(this),f=g.find("figure"),j=e._getDir(g,{x:i.pageX,y:i.pageY}),h=e._getStyle(j);if(i.type==="mouseenter"){f.hide().css(h.from);clearTimeout(e.tmhover);e.tmhover=setTimeout(function(){f.show(0,function(){var k=c(this);if(e.support){k.css("transition",e.transitionProp)}e._applyAnimation(k,h.to,e.options.speed)})},e.options.hoverDelay<?php echo $Total_Soft_Portfolio; ?>)}else{if(e.support){f.css("transition",e.transitionProp)}clearTimeout(e.tmhover);e._applyAnimation(f,h.from,e.options.speed)}})},_getDir:function(g,k){var f=g.width(),i=g.height(),e=(k.x-g.offset().left-(f/2))*(f>i?(i/f):1),l=(k.y-g.offset().top-(i/2))*(i>f?(f/i):1),j=Math.round((((Math.atan2(l,e)*(180/Math.PI))+180)/90)+3)%4;return j},_getStyle:function(k){var g,l,i={left:"0px",top:"-100%"},e={left:"0px",top:"100%"},h={left:"-100%",top:"0px"},f={left:"100%",top:"0px"},m={top:"0px"},j={left:"0px"};switch(k){case 0:g=!this.options.inverse?i:e;l=m;break;case 1:g=!this.options.inverse?f:h;l=j;break;case 2:g=!this.options.inverse?e:i;l=m;break;case 3:g=!this.options.inverse?h:f;l=j;break}return{from:g,to:l}},_applyAnimation:function(f,e,g){c.fn.applyStyle=this.support?c.fn.css:c.fn.animate;f.stop().applyStyle(e,c.extend(true,[],{duration:g+"ms"}))},};var a=function(e){if(b.console){b.console.error(e)}};c.fn.hoverdir=function(g){var e=c.data(this,"hoverdir");if(typeof g==="string"){var f=Array.prototype.slice.call(arguments,1);this.each(function(){if(!e){a("cannot call methods on hoverdir prior to initialization; attempted to call method '"+g+"'");return}if(!c.isFunction(e[g])||g.charAt(0)==="_"){a("no such method '"+g+"' for hoverdir instance");return}e[g].apply(e,f)})}else{this.each(function(){if(e){e._init()}else{e=c.data(this,"hoverdir",new c.HoverDir(g,this))}})}return e}})(jQuery,window);var $event=jQuery.event,$special,resizeTimeout;$special=$event.special.debouncedresize={setup:function(){jQuery(this).on("resize",$special.handler)},teardown:function(){jQuery(this).off("resize",$special.handler)},handler:function(e,a){var d=this,c=arguments,b=function(){e.type="debouncedresize";$event.dispatch.apply(d,c)};if(resizeTimeout){clearTimeout(resizeTimeout)}a?b():resizeTimeout=setTimeout(b,$special.threshold)},threshold:250};var BLANK="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";jQuery.fn.imagesLoaded=function(h){var e=this,j=jQuery.isFunction(jQuery.Deferred)?jQuery.Deferred():0,i=jQuery.isFunction(j.notify),b=e.find("img").add(e.filter("img")),c=[],g=[],d=[];if(jQuery.isPlainObject(h)){jQuery.each(h,function(k,l){if(k==="callback"){h=l}else{if(j){j[k](l)}}})}function f(){var k=jQuery(g),l=jQuery(d);if(j){if(d.length){j.reject(b,k,l)}else{j.resolve(b)}}if(jQuery.isFunction(h)){h.call(e,b,k,l)}}function a(k,l){if(k.src===BLANK||jQuery.inArray(k,c)!==-1){return}c.push(k);if(l){d.push(k)}else{g.push(k)}jQuery.data(k,"imagesLoaded",{isBroken:l,src:k.src});if(i){j.notifyWith(jQuery(k),[l,b,jQuery(g),jQuery(d)])}if(b.length===c.length){setTimeout(f);b.unbind(".imagesLoaded")}}if(!b.length){f()}else{b.bind("load.imagesLoaded error.imagesLoaded",function(k){a(k.target,k.type==="error")}).each(function(k,m){var n=m.src;var l=jQuery.data(m,"imagesLoaded");if(l&&l.src===n){a(m,l.isBroken);return}if(m.complete&&m.naturalWidth!==undefined){a(m,m.naturalWidth===0||m.naturalHeight===0);return}if(m.readyState||m.complete){m.src=BLANK;m.src=n}})}return j?j.promise(e):e};jQuery(function(){jQuery.elastic_grid<?php echo $Total_Soft_Portfolio; ?>={version:"1.0"};jQuery.fn.elastic_grid<?php echo $Total_Soft_Portfolio; ?>=function(G){G=jQuery.extend({},{items:null,filterEffect<?php echo $Total_Soft_Portfolio; ?>:"",hoverDirection<?php echo $Total_Soft_Portfolio; ?>:true,hoverDelay<?php echo $Total_Soft_Portfolio; ?>:0,hoverInverse<?php echo $Total_Soft_Portfolio; ?>:false,expandingHeight<?php echo $Total_Soft_Portfolio; ?>:500,expandingSpeed<?php echo $Total_Soft_Portfolio; ?>:300,callback:function(){}},G);var u=jQuery(this);var H=G.items.length;if(H==0){return false}u.html('<div class="wagwep-container wagwep-container<?php echo $Total_Soft_Portfolio; ?>"><nav id="porfolio-nav" class="clearfix porfolio-nav<?php echo $Total_Soft_Portfolio; ?>"><ul id="portfolio-filter" class="nav portfolio-filter<?php echo $Total_Soft_Portfolio; ?> nav-tabs clearfix"></ul></nav></div>');var g="";var o=jQuery('<ul id="og-grid<?php echo $Total_Soft_Portfolio; ?>" class="og-grid og-grid<?php echo $Total_Soft_Portfolio; ?>"></ul>');for(itemIdx=0;itemIdx<H;itemIdx++){if(G.items[itemIdx]!=undefined){var E=G.items[itemIdx];liObject=jQuery("<li></li>");tags=E.tags;strTag="";for(var C=tags.length-1;C>=0;C--){strTag+=","+tags[C]}strTag=strTag.substring(1);liObject.attr("data-tags",strTag);aObject=jQuery("<a></a>");aObject.attr("href","javascript:;;");imgObject=jQuery("<img/>");imgObject.attr("src",E.thumbnail[0]);imgObject.attr("data-largesrc",E.large[0]);spanObject=jQuery("<span></span>");spanObject.html(E.title[0]);figureObject=jQuery("<figure></figure>");figureObject.append(spanObject);imgObject.appendTo(aObject);figureObject.appendTo(aObject);aObject.appendTo(liObject);liObject.appendTo(o)}}if(G.filterEffect<?php echo $Total_Soft_Portfolio; ?>==""){G.filterEffect<?php echo $Total_Soft_Portfolio; ?>="moveup"}o.addClass("effect-"+G.filterEffect<?php echo $Total_Soft_Portfolio; ?>);o.appendTo(u);if(G.hoverDirection<?php echo $Total_Soft_Portfolio; ?>==true){o.find("li").each(function(){jQuery(this).hoverdir({hoverDelay<?php echo $Total_Soft_Portfolio; ?>:G.hoverDelay<?php echo $Total_Soft_Portfolio; ?>,inverse:G.hoverInverse<?php echo $Total_Soft_Portfolio; ?>})})}var m=u.find(".portfolio-filter<?php echo $Total_Soft_Portfolio; ?>");var x=o.find("li"),c={};numOfTag=0;x.each(function(J){var K=jQuery(this),I=K.data("tags").split(",");K.attr("data-id",J);K.addClass("all");jQuery.each(I,function(i,L){L=jQuery.trim(L);K.addClass(L.toLowerCase().replace(" ","-"));if(!(L in c)){c[L]=[];numOfTag++}c[L].push(K)})});if(numOfTag>1){f(G.showAllText<?php echo $Total_Soft_Portfolio; ?>);jQuery.each(c,function(I,i){f(I)})}else{m.remove()}m.find("a").bind("click",function(I){k.find("li.og-expanded<?php echo $Total_Soft_Portfolio; ?>").find("a").trigger("click");k.find(".og-close<?php echo $Total_Soft_Portfolio; ?>").trigger("click");$this=jQuery(this);$this.css("outline","none");m.find(".current").removeClass("current");$this.parent().addClass("current");var J=$this.text().toLowerCase().replace(" ","-");var i=H;o.find("li").each(function(K,L){classie.remove(L,"hidden");classie.remove(L,"animate");if(!--i){setTimeout(function(){p(o.find("li"),J)},1)}});return false});function p(i,I){i.each(function(J,K){if(classie.has(K,I)){classie.toggle(K,"animate");classie.remove(K,"hidden")}else{classie.add(K,"hidden");classie.remove(K,"animate")}})}m.find("li:first").addClass("current");function f(K){var J=K.toLowerCase().replace(" ","-");if(K!=""){var i=jQuery("<li>");var I=jQuery("<a>",{html:K,"data-filter":"."+J,href:"#","class":"filter",}).appendTo(i);i.appendTo(m)}}var k=o,h=k.children("li"),y=-1,t=-1,F=0,q=10,w=jQuery(window),d,A=jQuery("html, body"),B={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"},j=B[Modernizr.prefixed("transition")],s=Modernizr.csstransitions,D={minHeight:G.expandingHeight<?php echo $Total_Soft_Portfolio; ?>,speed:G.expandingSpeed<?php echo $Total_Soft_Portfolio; ?>,easing:"ease"};function v(i){h=h.add(i);i.each(function(){var I=jQuery(this);I.data({offsetTop:I.offset().top,height:I.height()})});l(i)}function r(i){h.each(function(){var I=jQuery(this);I.data("offsetTop",I.offset().top);if(i){I.data("height",I.height())}})}function n(){l(h);w.on("debouncedresize",function(){F=0;t=-1;r();b();var i=jQuery.data(this,"preview");if(typeof i!="undefined"){z()}})}function l(i){i.on("click","span.og-close<?php echo $Total_Soft_Portfolio; ?>",function(){z();return false}).children("a").on("click",function(J){var I=jQuery(this).parent();I.removeClass("animate");y===I.index()?z(jQuery(this)):a(I);return false})}function b(){d={width:w.width(),height:w.height()}}function a(I){z();var J=jQuery.data(this,"preview"),i=I.data("offsetTop");F=0;if(typeof J!="undefined"){if(t!==i){if(i>t){F=J.height}z()}else{J.update(I);return false}}t=i;J=jQuery.data(this,"preview",new e(I));J.open()}function z(){h.find(".og-pointer<?php echo $Total_Soft_Portfolio; ?>").remove();y=-1;var i=jQuery.data(this,"preview");if(typeof i=="undefined"){}else{i.close()}jQuery.removeData(this,"preview")}function e(i){this.$item=i;this.expandedIdx=this.$item.index();this.create();this.update()}e.prototype={create:function(){this.$title=jQuery("<h3></h3>");this.$description=jQuery("<p></p>");this.$href=jQuery('<a href="#">Visit website</a>');this.$detailButtonList=jQuery('<span class="buttons-list"></span>');this.$details=jQuery('<div class="og-details og-details<?php echo $Total_Soft_Portfolio; ?>"></div>').append(this.$title,this.$description,this.$detailButtonList);this.$loading=jQuery('<div class="og-loading"></div>');this.$fullimage=jQuery('<div class="og-fullimg"></div>').append(this.$loading);this.$closePreview=jQuery('<span class="og-close og-close<?php echo $Total_Soft_Portfolio; ?> totalsoft"></span>');this.$previewInner=jQuery('<div class="og-expander-inner"></div>').append(this.$closePreview,this.$fullimage,this.$details);this.$previewEl=jQuery('<div class="og-expander og-expander<?php echo $Total_Soft_Portfolio; ?>"></div>').append(this.$previewInner);this.$item.append(jQuery('<div class="og-pointer og-pointer<?php echo $Total_Soft_Portfolio; ?>"></div>'));this.$item.append(this.getEl());if(s){this.setTransition()}},update:function(L){if(L){this.$item=L}if(y!==-1){var K=h.eq(y);K.removeClass("og-expanded<?php echo $Total_Soft_Portfolio; ?>");this.$item.addClass("og-expanded<?php echo $Total_Soft_Portfolio; ?>");this.positionPreview()}y=this.$item.index();if(typeof G.items[y]==="undefined"){}else{eldata=G.items[y];this.$title.html(eldata.title[0]);this.$description.html(eldata.description[0]);this.$detailButtonList.html("");urlList=eldata.button_list;if(urlList.length>0){for(C=0;C<urlList.length;C++){var M=(urlList[C]["new_window"])?"_blank":"_self";var P=jQuery('<a target="'+M+'"></a>');P.addClass("link-button");if(C==0){P.addClass("first")}P.attr("href",urlList[C]["url"][0]);P.html(urlList[C]["title"]);this.$detailButtonList.append(P);if(P.attr("href")==""){P.css("display","none")}else{P.css("display","inline")}}}var O=this;if(typeof O.$largeImg!="undefined"){O.$largeImg.remove()}glarge=eldata.large;gthumbs=eldata.thumbnail;gtitle=eldata.title;gdescription=eldata.description;glink=eldata.button_list;if(glarge.length==gthumbs.length&&glarge.length>0){var i=jQuery("<ul></ul>");for(C=0;C<gthumbs.length;C++){var I=jQuery("<li></li>");var P=jQuery('<a href="javascript:;;"></a>');var J=jQuery("<img/>");J.addClass("related_photo");if(C==0){J.addClass("selected")}J.attr("src",gthumbs[C]);J.attr("data-large",glarge[C]);J.attr("name",gtitle[C]);J.attr("data-desc",gdescription[C]);J.attr("data-link",glink[0].url[C]);P.append(J);I.append(P);i.append(I)}i.addClass("elastislide<?php echo $Total_Soft_Portfolio; ?>-list");i.elastislide<?php echo $Total_Soft_Portfolio; ?>();var N=jQuery('<div class="elastislide<?php echo $Total_Soft_Portfolio; ?>-wrapper elastislide<?php echo $Total_Soft_Portfolio; ?>-horizontal"></div>');N.append(i).find(".related_photo").bind("click",function(){N.find(".selected").removeClass("selected");jQuery(this).addClass("selected");$largePhoto=jQuery(this).data("large");jQuery("<img/>").load(function(){O.$fullimage.find("img").fadeOut(500,function(){jQuery(this).fadeIn(500).attr("src",$largePhoto)})}).attr("src",$largePhoto);jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> h3").text(N.find(".selected").attr("name"));jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> p").html(N.find(".selected").attr("data-desc"));jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> a.link-button").attr("href",N.find(".selected").attr("data-link"));if(jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> a.link-button").attr("href")==""){jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> a.link-button").css("display","none")}else{jQuery(".og-details<?php echo $Total_Soft_Portfolio; ?> a.link-button").css("display","inline")}});O.$details.append('<div class="infosep"></div>');O.$details.append(N)}else{O.$details.find(".infosep, .og-grid-small").remove()}if(O.$fullimage.is(":visible")){this.$loading.show();jQuery("<img/>").load(function(){var Q=jQuery(this);if(Q.attr("src")===O.$item.children("a").find("img").data("largesrc")){O.$loading.hide();O.$fullimage.find("img").remove();O.$largeImg=Q.fadeIn(350);O.$fullimage.append(O.$largeImg)}}).attr("src",eldata.large[0])}}},open:function(){setTimeout(jQuery.proxy(function(){this.setHeights();this.positionPreview()},this),25)},close:function(){var i=this,I=function(){if(s){jQuery(this).off(j)}i.$item.removeClass("og-expanded<?php echo $Total_Soft_Portfolio; ?>"); i.$previewEl.remove()};setTimeout(jQuery.proxy(function(){if(typeof this.$largeImg!=="undefined"){this.$largeImg.fadeOut("fast")}this.$previewEl.css("height",0);var J=h.eq(this.expandedIdx);J.css("height",J.data("height")).on(j,I);if(!s){I.call()}},this),25);return false},calcHeight:function(){var I=D.minHeight,i=D.minHeight+this.$item.data("height")+q; this.height=I; this.itemHeight=i},setHeights:function(){var i=this,I=function(){if(s){i.$item.off(j)}i.$item.addClass("og-expanded<?php echo $Total_Soft_Portfolio; ?>")};this.calcHeight(); this.$previewEl.css("height",this.height); this.$item.css("height",this.itemHeight).on(j,I);if(!s){I.call()}},positionPreview:function(){var I=this.$item.data("offsetTop"),i=this.$previewEl.offset().top-F,J=this.height+this.$item.data("height")+q<=d.height?I:this.height<d.height?i-(d.height-this.height):i; A.animate({scrollTop:J},D.speed)},setTransition:function(){this.$previewEl.css("transition","height "+D.speed+"ms "+D.easing);this.$item.css("transition","height "+D.speed+"ms "+D.easing)},getEl:function(){return this.$previewEl}};k.imagesLoaded(function(){r(true);b();n()})}});
				</script>
				<script type="text/javascript">
				    jQuery(function(){
	 		...
	 		<?php }else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Filterable Grid'){ ?>
 				<style type="text/css">
	 				...
	 				{
	 					padding:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_04;?>px;
						box-sizing:border-box;
						-moz-box-sizing:border-box;
						-webkit-box-sizing:border-box;
	 				}
	 				...
	 				<?php } elseif($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_19 == "Effect 2") { ?>
		 				...
		 				.filter__item<?php echo $Total_Soft_Portfolio; ?>--selected 
		 				{
							...
							box-shadow: 0px 4px 60px 0px rgba(0, 0, 0, 0.75) !important;
							-moz-box-shadow: 0px 4px 60px 0px rgba(0, 0, 0, 0.75) !important;
							-webkit-box-shadow: 0px 4px 60px 0px rgba(0, 0, 0, 0.75) !important;
						}
						.filter__item<?php echo $Total_Soft_Portfolio; ?>:hover
						{
							color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_14;?> !important;
					...
					.carImgs
					{
						...
						margin-left:2px;
						margin-right:2px;
						height:<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_18;?>px;
					}
					.leftClickPortSl
					{
						position:absolute;
					...
					{ 
						...
						width:<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_16;?>px !important;
						max-width:95%;
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Gallery Portfolio/Content Popup'){ ?>
			    ...
			    <script type="text/javascript">
					function resp(){
						jQuery('.pp_description').css('font-size',Math.ceil(<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_02;?>*jQuery('.pp_hoverContainer').width()/(jQuery('.pp_hoverContainer').width()+50)));
						jQuery('.totalsoft-port-cpop-close').css('font-size',Math.ceil(<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_09;?>*jQuery('.pp_hoverContainer').width()/(jQuery('.pp_hoverContainer').width()+50)));
						jQuery('.totalsoft-port-cpop-pl-pa').css('font-size',Math.ceil(<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_06;?>*jQuery('.pp_hoverContainer').width()/(jQuery('.pp_hoverContainer').width()+50)));
						jQuery('.totalsoft-port-cpop-nepr').css('font-size',Math.ceil(<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_14;?>*jQuery('.pp_hoverContainer').width()/(jQuery('.pp_hoverContainer').width()+50)));
						jQuery('.totalsoft-port-cpop-text').css('font-size',Math.ceil(<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_16;?>*jQuery('.pp_hoverContainer').width()/(jQuery('.pp_hoverContainer').width()+50)));
					}
				        ...
				        <div class="pp_content"> \
				         ...
				         <div class="pp_fade"> \
				          ...
				          <div class="pp_details clearfix"> \
				           ...
				           <i class="totalsoft-port-cpop-close pp_close totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_08;?>"><span><?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_11;?></span></i> \
				           <div class="pp_nav"> \
				            <i href="#" class="pp_arrow_previous totalsoft-port-cpop-nepr totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_13;?>-left"></i> \
				            <p class="currentTextHolder totalsoft-port-cpop-text">0/0</p> \
				            <i href="#" class="pp_arrow_next totalsoft-port-cpop-nepr totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_13;?>-right"></i> \
				           </div> \
				          </div> \
				         </div> \
				        </div> \
				...
				$.prettyPhoto.changePage=function(direction){currentGalleryPage=0;if(direction=='previous'){set_position--;if(set_position<0){set_position=0;return;}}else if(direction=='next'){set_position++;if(set_position>$(pp_images).size()-1){set_position=0;}}else{set_position=direction;};if(!doresize)doresize=true;$('.pp_contract').removeClass('pp_contract').addClass('pp_expand');_hideContent(function(){$.prettyPhoto.open();});};$.prettyPhoto.changeGalleryPage=function(direction){if(direction=='next'){currentGalleryPage++;if(currentGalleryPage>totalPage){currentGalleryPage=0};}else if(direction=='previous'){currentGalleryPage--;if(currentGalleryPage<0){currentGalleryPage=totalPage;}}else{currentGalleryPage=direction;};itemsToSlide=(currentGalleryPage==totalPage)?pp_images.length-((totalPage)*itemsPerPage):itemsPerPage;$pp_pic_holder.find('.pp_gallery li').each(function(i){$(this).animate({'left':(i*itemWidth)-((itemsToSlide*itemWidth)*currentGalleryPage)});});};$.prettyPhoto.startSlideshow=function(){setTimeout(function(){resp()},450);if(typeof pp_slideshow=='undefined'){$pp_pic_holder.find('.pp_play').unbind('click').removeClass('pp_play totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_05;?>').addClass('pp_pause totalsoft totalsoft-<?php echo str_replace("play","pause", $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_05); ?>').click(function(){$.prettyPhoto.stopSlideshow();return false;});pp_slideshow=setInterval($.prettyPhoto.startSlideshow,settings.slideshow);}else{$.prettyPhoto.changePage('next');};}
				$.prettyPhoto.stopSlideshow=function(){$pp_pic_holder.find('.pp_pause').unbind('click').removeClass('pp_pause totalsoft totalsoft-<?php echo str_replace("play","pause", $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_05); ?>').addClass('pp_play totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_05;?>').click(function(){$.prettyPhoto.startSlideshow();return false;});clearInterval(pp_slideshow);pp_slideshow=undefined;}
			    ...
			    <style type="text/css">						
					...
					{
						font-size: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_06;?>px !important;
					...
					.TotPortHovLink,.TotPortHovLink:hover { text-decoration:none; }
	 			...
	 			<div class="totalsoft-TS_Portfolio_GAA_" >
				   	<div class="totalsoft-portfolio-content">	
				   		<ul class="totalsoft-portfolio-categ totalsoft-portfolio-categ<?php echo $Total_Soft_Portfolio; ?> filter">
						...
						<ul class="totalsoft-portfolio-area<?php echo $Total_Soft_Portfolio; ?>" style='padding:0px;margin:0px;text-align:center;'>	
							<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){
			            				...
			            				<li class="totalsoft-portfolio-item2<?php echo $Total_Soft_Portfolio; ?>" data-id="id<?php echo $Total_Soft_Portfolio; ?>-<?php echo $i . $j;?>" data-type="portfolio-totalsoft-album<?php echo $Total_Soft_Portfolio; ?>-<?php echo $i;?>">
			            					 <div>
								                <span class="totalsoft-image-block">
													<a class="totalsoft-image-zoom" href="<?php echo $TSoftPort_ContPop_Images[$j]->TotalSoftPortfolio_IURL;?>" rel="prettyPhoto[gallery<?php echo $Total_Soft_Portfolio; ?>]" title="<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_39=='true'){ echo html_entity_decode($TSoftPort_ContPop_Images[$j]->TotalSoftPortfolio_IT);} ?>">
														...
														<div class='<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_12;?>'>
														...
														<div class='<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_23;?>'>
				...
				<script>
					...
					function resp<?php echo $Total_Soft_Portfolio; ?>(){							
						jQuery('.pp_description').animate('font-size',Math.ceil(portPoppTitleFS<?php echo $Total_Soft_Portfolio; ?>*jQuery('#fullResImage').prop('naturalWidth')/(jQuery('#fullResImage').prop('naturalWidth')+150)));
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Gallery Album Animation'){ ?>
				<style type="text/css">
					...
					#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-inner-left { left: 20px; top: 50%; margin-top: -17.5px; }
					#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-inner-right { top: 50%; right: 20px; margin-top: -17.5px; }
					#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-inner-close { top: 0px; right: 0px; margin-top: 20px; margin-right: 20px; }
					...
					#TS_Portfolio_GAA_fullscreen<?php echo $Total_Soft_Portfolio;?>-image img { position: absolute; left: 50%; top: 50%; -webkit-transition: all 0.5s; -moz-transition: all 0.5s; -o-transition: all 0.5s; transition: all 0.5s; -ms-transform: scale(1.5,1.5); -webkit-transform: scale(1.5,1.5); transform: scale(1.5,1.5); opacity: 0; }
				...
				<div id="TS_Portfolio_GAA<?php echo $Total_Soft_Portfolio;?>">
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Portfolio / Hover Effects'){ ?>
				...
				<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02 == 'true'){ ?>
					<div class="button-group filters-button-group filters-button-group_<?php echo $Total_Soft_Portfolio;?>">
					    ...
					    <?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){ ?>
					   		<button class="button TSPortfolioHE_Button_<?php echo $Total_Soft_Portfolio;?>" data-filter=".<?php echo str_replace(" ","_", $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle) . $Total_Soft_Portfolio;?>">
				...
				<section id="grid-container" class="transitions-enabled fluid masonry js-masonry TSPortfolioHE_<?php echo $Total_Soft_Portfolio;?>">
				    <?php for($i=0;$i<count($TotalSoftPortfolioImages);$i++){ ?>
				    	<article class="<?php echo str_replace(" ","_", $TotalSoftPortfolioImages[$i]->TotalSoftPortfolio_IA) . $Total_Soft_Portfolio;?>">
					...
					?>
						<div class="TSPortfolioHE_Ov_Div1 TSPortfolioHE_Ov_Div1_<?php echo $i+1;?>">
							<div class="TSPortfolioHE_Ov_Div2">
								...
								<span class="TSPortfolioHE_Ov_Div_Span_<?php echo $Total_Soft_Portfolio;?>" onclick="OpenTSPortfolioHE_Pop(<?php echo $Total_Soft_Portfolio;?>, <?php echo $prevImage;?>)"><i class="totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_01;?>-left"></i></span>
								<span class="TSPortfolioHE_Ov_Div_Span_<?php echo $Total_Soft_Portfolio;?>" onclick="OpenTSPortfolioHE_Pop(<?php echo $Total_Soft_Portfolio;?>, <?php echo $nextImage;?>)"><i class="totalsoft totalsoft-<?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_01;?>-right"></i></span>
							</div>
				...
				<script type="text/javascript">
					...
					jQuery(window).bind("load", function() { jQuery('.TSPortfolioHE_Button_<?php echo $Total_Soft_Portfolio;?>.is-checked').click(); });	
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType=='Lightbox Gallery'){ ?>
				...
				<style type="text/css">
					...
					<?php } else if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_09 == 'effect09') { ?>
						...
						.TotalSoft_PG_LG_Button_<?php echo $Total_Soft_Portfolio;?>:hover .TotalSoft_PG_LG_Button_Span_<?php echo $Total_Soft_Portfolio;?>, .TotalSoft_PG_LG_Button_Ch_<?php echo $Total_Soft_Portfolio;?> span
						{
							...
							text-shadow: 0 45px 0 <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_06;?>, 0 0 0 <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_11;?>;
						}
						.TotalSoft_PG_LG_Button_Span_<?php echo $Total_Soft_Portfolio;?>
						{
							color: rgba(0,0,0,0) !important;
						...
						<div class="TotalSoft_PG_LG_Button_Div2_<?php echo $Total_Soft_Portfolio;?>">
					  	...
					  	<?php for($i=0;$i<$TotalSoftPortfolioManager[0]->TotalSoftPortfolio_AlbumCount;$i++){ ?>
						  	<div class="TotalSoft_PG_LG_Button_Div2_<?php echo $Total_Soft_Portfolio;?>">
						    	...
						    	<button class="TotalSoft_PG_LG_Button_<?php echo $Total_Soft_Portfolio;?>" data-rel<?php echo $Total_Soft_Portfolio;?>="<?php echo str_replace(" ","", $TotalSoftPortfolioAlbums[$i]->TotalSoftPortfolio_ATitle) . $Total_Soft_Portfolio;?>">
				...
				<div class="TotalSoft_PG_LG_Container_<?php echo $Total_Soft_Portfolio;?>" ng-class="{'no-scroll<?php echo $Total_Soft_Portfolio;?>': selected<?php echo $Total_Soft_Portfolio;?>.length}" ng-module="app<?php echo $Total_Soft_Portfolio;?>" ng-controller="mainCtrl<?php echo $Total_Soft_Portfolio;?>">
					...
					<div class="scroller<?php echo $Total_Soft_Portfolio;?>" ng-show="selected<?php echo $Total_Soft_Portfolio;?>.length">
				...
				<script type="text/javascript">
					...
					jQuery(".TotalSoft_PG_LG_Button_<?php echo $Total_Soft_Portfolio;?>").click(function(){														
						if(!jQuery(this).hasClass('TotalSoft_PG_LG_Button_Ch_<?php echo $Total_Soft_Portfolio;?>'))
						{
							...
							selectedClass<?php echo $Total_Soft_Portfolio;?> = jQuery(this).attr("data-rel<?php echo $Total_Soft_Portfolio;?>"); 
					     	jQuery(".TotalSoft_PG_LG_Grid_<?php echo $Total_Soft_Portfolio;?>").fadeTo(100, 0.1);
						    ...
						    setTimeout(function() {
						      	...
						      	jQuery(".TotalSoft_PG_LG_Grid_<?php echo $Total_Soft_Portfolio;?>").fadeTo(300, 1);
						    }, 300);
						}																	
					});
					...
					app<?php echo $Total_Soft_Portfolio;?>.controller('mainCtrl<?php echo $Total_Soft_Portfolio;?>', function($scope) {
						$scope.boxes = [
							<?php for($i=0;$i<count($TotalSoftPortfolioImages);$i++){ ?>
								{
									album: '<?php echo str_replace(' ', '', $TotalSoftPortfolioImages[$i]->TotalSoftPortfolio_IA) . $Total_Soft_Portfolio;?>',
						...
						$scope.selectBox<?php echo $Total_Soft_Portfolio;?> = function(item, position) {
							$scope.selected<?php echo $Total_Soft_Portfolio;?> = [{
								item: item,
								position: position
							}];
